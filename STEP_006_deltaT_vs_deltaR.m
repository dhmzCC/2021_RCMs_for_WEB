...
for M=[1:M_R(R)];
  ...
  v1_MON{S,R,M}=load(['./PODACI_txt/STATION',num2str(S),'_MOD',num2str(M),'_RCP',num2str(R),'_VAR1_ORIG.txt']);
  v2_MON{S,R,M}=load(['./PODACI_txt/STATION',num2str(S),'_MOD',num2str(M),'_RCP',num2str(R),'_VAR2_ORIG.txt']);
